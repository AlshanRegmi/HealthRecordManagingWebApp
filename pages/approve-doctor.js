...
renderRecords() {
  ...
  render() {
    const { showAddress, loadingApprove, loadingShowHide } = this.state;

    return (
        <Layout>
          <Grid centered>
            <GridColumn mobile={16} tablet={8} computer={6} style={{ marginTop: "20px" }}>
            ...
            <GridColumn mobile={16} tablet={8} computer={10} style={{ marginTop: "20px" }}>
